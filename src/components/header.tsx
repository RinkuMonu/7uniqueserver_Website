          ...
          <div className="row">
            <div className="rts-ht__wrapper">
              ...
              <div className="rts-ht__promo">
                <p>
                  <Image
                    src="/images/icon/tag--group.svg"
                    alt="tag icon"
                    width={16}
                    height={16}
                    className="icon"
                  />
                  Hosting Flash Sale: Starting at <strong>$2.59/mo</strong> for
                  a limited time
                </p>
              </div>
                  ...
                  <ul className="list-unstyled elitehost-desktop-menu">
                          ...
                          {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div className="col homemenu" key={i}>
                              <div className="homemenu-thumb mb-15">
                                <Link
                                  href={`/index${i === 1 ? "" : `-${i}`}.html`}
                                >
                                  <Image
                                    src={`/images/home/home-${i}.webp`}
                                    alt={`Home ${i}`}
                                    width={160}
                                    height={100}
                                  />
                              ...
                              [
                                {
                                  ...
                                  desc: "Get know about Elitehost",
                                },
                                {
                                  href: "pricing.html",
                                  icon: "03.svg",
                                  title: "Pricing",
                                  desc: "Elitehost provide pro price",
                                },
                                {
                                  href: "blog.html",
                                  icon: "07.svg",
                                  title: "Blog",
                                  desc: "Read Elitehost article",
                                },
                              ],
                              [
                                {
                    ...
                    <li className="menu-item elitehost-has-dropdown">
                      ...
                      <ul className="elitehost-submenu list-unstyled menu-pages">
                        ...
                        <li className="nav-item">
                          <Link href="support.html" className="nav-link">
                            Support
                          </Link>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                          <Link href="knowledgebase.html" className="nav-link">
                            Knowledgebase
                          </Link>
                        </li>
                      </ul>
